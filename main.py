...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "Mp ORBbot 🚀\n"
        "• /symbols – välj vilka coins som ska handlas\n"
        "• /status – se engine & PnL\n"
        "• /mode – AI-läge (neutral/aggressive/cautious)\n"
        "• /entry_mode – CLOSE eller TICK\n"
        "Engine kör auto-ORB på ny 3m candle med mock-trades."
    )
