# -*- coding: utf-8 -*-
# MP Hybrid ORB/MOMO Bot – Optimized v3 (NO SHORT, buttons, stats, max daily loss)
    ...
    while True:
        ...
        if STATE.max_daily_loss > 0:
            ...
            if daily_pnl <= -STATE.max_daily_loss:
                # Stäng alla positioner & stoppa engine
...
async def cmd_start(update: Update, _):
    ...
    await tg_app.bot.send_message(
        STATE.chat_id,
        "🤖 MP ORB/MOMO Bot – Optimized v3\n"
        "Standardläge: MOCK (simulerad).\n"
        "Nyheter:\n"
        "• /stats för trade-statistik\n"
        "• Max daily loss skyddar kontot.",
...
async def root():
    ...
    return (
        f"MP Bot Optimized v3 OK | engine={STATE.engine} | "
