...
#  - job_queue-fix (ingen NoneType.run_repeating-bugg)
...
# ---------------------------------------------------
# ENGINE-SCHEDULER (redo för riktig data senare)
# ---------------------------------------------------
...
async def main() -> None:
    ...
    # job_queue – FIX: använd separat variabel, inte app.job_queue.run_repeating direkt
    job_queue = app.job_queue
    job_queue.run_repeating(engine_loop, interval=10, first=10)
