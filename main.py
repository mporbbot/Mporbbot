...
# --------------------------------------------------------------------
# Byt ut "8265069090:AAFd4L9TwrHqS0HrPqzNPt6V5sEMZ9Oz6Wg" mot din riktiga token från BotFather
# t.ex: "8265069090:AAFd4L9TwrHqS0HrPqzNPt6V5sEMZ9Oz6Wg"

BOT_TOKEN = "DIN_TELEGRAM_TOKEN_HÄR"

# Om du ändå vill ha möjlighet att sätta via env i framtiden kan du göra:
# BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "DIN_TELEGRAM_TOKEN_HÄR")

if not BOT_TOKEN or BOT_TOKEN == "DIN_TELEGRAM_TOKEN_HÄR":
...
# --------------------------------------------------------------------
# Platshållare för ORB / backtest / mocktrades / CSV
# --------------------------------------------------------------------
