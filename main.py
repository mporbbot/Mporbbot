...
#   • Öppnar entries:
#       - Trend/Momentum (MOMO): om momentum_score > threshold → LONG, ev. SHORT i mock-läge.
#       - Mean Reversion (MR): om priset avviker från EMA20 mer än MR_DEV_PCT → LONG eller SHORT (mock).
#   • TP / SL / Trailing:
#       - TP: TP_PCT.
#       - SL: SL_PCT.
...
class EngineState:
    ...
    allow_shorts: bool = True  # Shorts endast i mock
...
async def cmd_reset_pnl(update: Update, _):
    ...
    # Nollställ även loss-guard-status
    STATE.loss_streak = 0
    STATE.paused_until = None
